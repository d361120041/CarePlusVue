...
<style scoped>
/* ---------- 版型 ---------- */
.page-wrapper{height:100%;padding:24px;background:#f5f6fa}
...
.btn-primary{background:#2563eb;color:#fff;border:none}.btn-primary:hover{background:#1d4ed8}
.btn-secondary{background:#dc2626;border:1px solid #d1d5db}.btn-secondary:hover{background:#f3f4f6}
...
.col-idx{width:30px}.col-cover{width:80px}.col-title{width:236px}.col-cat{width:120px}.col-duration{width:80px}.col-action{width:110px}

/* ---------- 其他 ---------- */
.cover-img{width:80px;height:80px;object-fit:cover;border-radius:4px;border:1px solid #d1d5db}
...
.row-add{background:#f9fafb;cursor:pointer;text-align:center;transition:background .2s}
...
.link.blue{color:#2563eb}.link.blue:hover{color:#1d4ed8}
.link.green{color:#16a34a}.link.green:hover{color:#15803d}
.link.red{color:#dc2626}.link.red:hover{color:#b91c1c}
.link.gray{color:#6b7280}.link.gray:hover{color:#4b5563}
.action-cell{display:flex;gap:8px;align-items:center;justify-content:flex-start;height:105px}
.text-cat{color:#64748b}
.link-title{color:#111827;text-decoration:none}.link-title:hover{font-weight:500}
</style>
